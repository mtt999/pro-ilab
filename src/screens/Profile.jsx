...
// ══════════════════════════════════════════════════════════════
// SOLO TEAMMATES — invite / accept / manage workspace sharing
// ══════════════════════════════════════════════════════════════
function TeammatesPanel({ session }) {
  ...
  async function load() {
    ...
    // Incoming pending invites (sent to my email)
    if (session?.email) {
    ...
    // My workspace members (who I invited and accepted)
  ...
  async function removeMember(memberId) {
    ...
    // Also reset invite so it can be re-sent
